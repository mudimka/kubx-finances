...
class NewsTable extends \Bitrix\Iblock\ElementTable
{
    public static function setDefaultScope($query){
        $query
            ->where("IBLOCK_ID", Constants::IB_NEWS)
            ->where("ACTIVE", true);
    ...
    public static function withSelect(Query $query)
    {
        $query->registerRuntimeField(
            ...
            new ReferenceField(
                ...
                [
                    ...
                    'ref.IBLOCK_PROPERTY_ID' => new SqlExpression('?',Constants::IB_PROP_NEWS_TITLE),
                ]
            )
        );
        ...
        $query->registerRuntimeField(
            ...
            new ReferenceField(
                ...
                [
                    'this.ID' => 'ref.IBLOCK_ELEMENT_ID',
                    'ref.IBLOCK_PROPERTY_ID' => new SqlExpression('?',Constants::IB_PROP_NEWS_IMAGE),
                ]
            )
        );
        ...
        $query->registerRuntimeField(
            ...
            new ReferenceField(
                ...
                [
                    'this.ID' => 'ref.IBLOCK_ELEMENT_ID',
                    'ref.IBLOCK_PROPERTY_ID' => new SqlExpression('?',Constants::IB_PROP_NEWS_PREVIEW_DESCRIPTION),
                ]
            )
        );
    ...
    public static function withDetailSelect(Query $query)
    {
        ...
        $query->registerRuntimeField(
            ...
            new ReferenceField(
                ...
                [
                    'this.ID' => 'ref.IBLOCK_ELEMENT_ID',
                    'ref.IBLOCK_PROPERTY_ID' => new SqlExpression('?',Constants::IB_PROP_NEWS_DETAIL_CONTENT),
                ]
            )
        );
    ...
    public static function withSection(Query $query, $code)
    {
        if (isset($code)) {
